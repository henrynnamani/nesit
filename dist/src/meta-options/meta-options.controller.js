...
const create_post_meta_option_dto_1 = require("./dto/create-post-meta-option.dto");
let MetaOptionsController = class MetaOptionsController {
    ...
    async createMetaOption(createPostMetaOptionDto) {
...
__decorate([
    ...
    __metadata("design:paramtypes", [create_post_meta_option_dto_1.CreatePostMetaOptionDto]),
    __metadata("design:returntype", Promise)
], MetaOptionsController.prototype, "createMetaOption", null);
