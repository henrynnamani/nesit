...
exports.FirstMigration1751139307305 = void 0;
class FirstMigration1751139307305 {
    name = 'FirstMigration1751139307305';
    async up(queryRunner) {
        ...
        await queryRunner.query(`CREATE TABLE "users" ("id" SERIAL NOT NULL, "firstName" character varying(96), "lastName" character varying(96), "email" character varying(96) NOT NULL, "password" character varying(96), "googleId" character varying, CONSTRAINT "UQ_97672ac88f789774dd47f7c8be3" UNIQUE ("email"), CONSTRAINT "PK_a3ffb1c0c8416b9fc6f907b7433" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "post" ("id" SERIAL NOT NULL, "title" character varying(512) NOT NULL, "postType" "public"."post_posttype_enum" NOT NULL DEFAULT 'post', "slug" character varying NOT NULL, "status" "public"."post_status_enum" NOT NULL DEFAULT 'draft', "content" character varying NOT NULL, "schema" character varying NOT NULL, "featuredImageUrl" character varying, "publishOn" TIMESTAMP, "authorId" integer, CONSTRAINT "PK_be5fda3aac270b134ff9c21cdee" PRIMARY KEY ("id"))`);
...
exports.FirstMigration1751139307305 = FirstMigration1751139307305;
//# sourceMappingURL=1751139307305-firstMigration.js.map